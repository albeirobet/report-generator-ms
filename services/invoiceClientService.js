...
exports.loadInvoiceClients = async (req, res) => {
  try {
    this.loadInvoiceClientsAsyncy(req, res);
...
exports.loadInvoiceClientsAsyncy = async (req, res) => {
  try {
    ...
    await reportFunctionsUpdate.updateReportUploader(objectReportResume);
    await InvoiceClient.collection
      .insertMany(invoiceClients)
      .then(function() {
        ...
        async function finishReport() {
          ...
          objectReportResume.counterRows = invoiceClients.length;
