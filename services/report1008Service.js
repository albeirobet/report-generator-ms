...
const Report1008 = require('../models/report1008Model');
...
exports.generateReport = async (req, res) => {
  try {
    ...
    objectReportResume.code = '1008GR';
    ...
    await Report1008.collection.deleteMany({
      companyId: userInfo.companyId
    });
    let arrayGenerated = [];
    ...
    for await (const reportData of masterReportData) {
      ...
      objectGenerated.saldoCuentasPorCobrar =
...
exports.sendReportCSV = async (req, res) => {
  try {
    ...
    const reportData = await Report1008.find({
      companyId: userInfo.companyId
    }).lean();
