      ...
      workSheet.eachRow(function(row, rowNumber) {
        ...
        if (count > constants.MASTER_REPORT_TEMPLATE_ROW_INIT) {
          const report = {
            ...
            originalPosition: currRow.getCell(16).value,
            operatingDocumentID: currRow.getCell(17).value,
            operatingDocumentCounterpartID: currRow.getCell(18).value,
            thirdId: currRow.getCell(19).value,
            thirdName: currRow.getCell(20).value,
            businessPartnerID: currRow.getCell(21).value,
            businessPartnerName: currRow.getCell(22).value,

            journalEntryHeaderText: currRow.getCell(23).value,
            accountingEntryItemText: currRow.getCell(24).value,
