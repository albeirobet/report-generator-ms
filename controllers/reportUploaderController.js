...
const reportUploaderService = require('../services/reportUploaderService');
...
exports.createReport = async (req, res) => {
  ...
  try {
    const data = await reportUploaderService.createReport(req, res);
...
exports.getReport = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await reportUploaderService.getReport(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.getAllAllReports = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await reportUploaderService.getAllAllReports(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
