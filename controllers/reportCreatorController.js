...
exports.generateReport1005 = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await reportCreatorService.generateReport1005(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.generateReport1006 = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await reportCreatorService.generateReport1006(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.generateReport1007 = async (req, res) => {
  let codeHttp = httpCodes.OK;
  let generalResponse = new GeneralResponse();
  generalResponse.success = true;
  try {
    const data = await reportCreatorService.generateReport1007(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.generateReport1008 = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await reportCreatorService.generateReport1008(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.generateReport1009 = async (req, res) => {
  let codeHttp = httpCodes.OK;
  let generalResponse = new GeneralResponse();
  generalResponse.success = true;
  try {
    const data = await reportCreatorService.generateReport1009(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
