...
exports.loadClients = async (req, res) => {
  ...
  try {
    const data = await clientService.loadClients(req, res);
...
exports.deleteClients = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await clientService.deleteClients(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.countClients = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await clientService.countClients(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.getClient = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await clientService.getClient(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
...
exports.getAllClients = async (req, res) => {
  ...
  generalResponse.success = true;
  try {
    const data = await clientService.getAllClients(req, res);
    generalResponse = generalResp.generalSuccess(data);
  } catch (err) {
    generalResponse = generalResp.generalError(err);
    console.error(generalResponse.apiError.messageUser);
